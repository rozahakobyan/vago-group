...
function Contacts(){
    return(
        <div className="EmploymentAgency-contactsArea">
            <div className="EmploymentAgency-contactsTitle">
                <h2>Contacts</h2>
            </div>
            <div className="EmploymentAgency-contactsMap">
            ...
            <div className="EmploymentAgency-contactsFormArea">
                <div className="EmploymentAgency-contacts-Area">
                    <form>
